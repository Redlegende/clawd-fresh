#!/usr/bin/env python3
"""Fetch 30 days of Garmin data with MFA from env var"""
...
try:
    ...
    if not mfa:
        print("❌ Set GARMIN_MFA environment variable with the code from your email")
        exit(1)
...
# Also save tokens for future use
tokens = {
...
print(f"💾 Tokens saved to .garmin_tokens.json")
